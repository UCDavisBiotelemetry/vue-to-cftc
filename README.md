# Project Goal of vue-to-cftc #
  Enables the field biologist maintaining a CFTC core array receiver to submit data in a format acceptable to our database.
  This is achieved by providing the scientist with a series of useful, small programs and a corresponding Microsoft Access Database and instruction for use.
...
<h2>Basic script file usage instructions</h2>
 In windows drag desired **.csv** files generated by VUE output on top of one of the three <em>vue-to-cftc<strong>.bat</strong></em>s.
